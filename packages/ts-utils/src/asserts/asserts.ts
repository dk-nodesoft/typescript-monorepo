...
export function assertIsPresent<T>(v: T, msgOrErrorFactory?: MsgOrErrorFactory): asserts v is NonNullable<T> {
  if (v === null || v === undefined) {
    throw createAssertException(msgOrErrorFactory, 'Value is null or undefined.');
  }
}

export function assertSafeInteger(v: unknown, msgOrErrorFactory?: MsgOrErrorFactory): asserts v is number {
